...
ClassImp(R3BTPCSetup)

R3BTPCSetup::R3BTPCSetup(int verbose=0)
{
   ReadConfigurationFile("ConfigFileSetup.txt",verbose);
}

R3BTPCSetup::~R3BTPCSetup(){
}

void R3BTPCSetup::ReadConfigurationFile(string Config,int verbose)
{
   string LineBuffer;
   string DataBuffer;
   ...
   TString dir = getenv("TPCLIBDIR");
   TString Path = dir+"/Inputs/"+Config;
   ifstream ConfigFile;
